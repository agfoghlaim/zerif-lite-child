	...
	<div class="container">
		...
		<div class="content-left-wrap col-md-9">
			...
			<div id="primary" class="content-area">
				...
				<?php
				while ( have_posts() ) :
							//moh add custom fields info
						
						$meta_date = get_post_meta($post->ID, 'Event Date', true);
						$meta_location = get_post_meta($post->ID, 'Event Location', true);
						if(!empty($meta_date)){
							echo '<p>Date: '.$meta_date.'</p>';
						}
						if(!empty($meta_location)){
							echo '<p>Location: '.$meta_location.'</p>';
						}
					//the_post();
