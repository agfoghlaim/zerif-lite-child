...
echo '<section style="padding-top:0px" class="focus ' . ( ( is_customize_preview() && ( ! isset( $zerif_ourfocus_show ) || $zerif_ourfocus_show == 1 ) ) ? ' zerif_hidden_if_not_customizer ' : '' ) . '" id="focus">';

?>

	<?php zerif_top_our_focus_trigger(); ?>
	<?php get_template_part( 'ywig_templates/ywig_green_row' ); ?>
	<div class="container">
