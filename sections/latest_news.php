...
if ( ! empty( $zerif_total_posts ) && ( $zerif_total_posts > 0 ) ) :
	...
	echo '<div class="ywig-news-wrap"></div>';
	echo '<div class="ywig-news-slant"></div>';
	...
	echo '<div class="container">';
		...
		echo '<div class="clear"></div>';
			/*ywig add widget area for facebook feed*/

	echo '<div class="col col-md-9 ywig-news-column">';
	...
	if ( $zerif_latest_loop->have_posts() ) :
		...
		while ( $zerif_latest_loop->have_posts() ) :
			...
			if ( ! wp_is_mobile() ) {
				...
				if ( $i_latest_posts == 1 ) {
					echo $newSlideActive;
				} elseif ( $i_latest_posts % 6 == 1 ) {
					echo $newSlide;
				}

					echo '<div class="col-sm-6 latestnews-box">';
	...
	if ( ! wp_is_mobile() ) {
		...
		/*ywig end col-6*/
		echo '</div>';
		/*ywig start widget area*/
		?>
		<div class="col col-md-3 ywig-news-column">
			
			<?php if( dynamic_sidebar( 'ywig-sidebar-news' )): else: endif; ?>
		</div>
		<?php
	echo '</div><!-- .container -->';
