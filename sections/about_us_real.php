...
?>
	...
	<div class="container">
		...
		<div class="section-header">
			<div class="row">
				<div class="col-12">
					<p class="text-center"><img src="http://138.68.182.248/wp-content/uploads/2018/05/ywig_tiny_colour.png" class="img-responsive center-block"></p>
				</div>
			</div>
...
if ( ! empty( $zerif_aboutus_feature4_nr ) || ! empty( $zerif_aboutus_feature4_title ) || ! empty( $zerif_aboutus_feature4_text ) ) {
	...
	if ( ! empty( $zerif_aboutus_feature4_nr ) ) {
		...
		echo '<div class="skill-count">';
		?>
		<img src="http://138.68.182.248/wp-content/uploads/2018/04/ywi_logo-e1525092895223.png">
		<?php
...
?>
	...
	<div class="row">
		<div class="col-md-4 ywig-what">
			<p>stuff in the paragraph</p>
		</div>
		<div class="col-md-4 ywig-what">
			<p>stuff in the paragraph</p>
		</div>
